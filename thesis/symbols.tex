...
\newcommand{\affz}{\text{Aff}_{\mathbb{Z}}}
...
\newcommand{\listofsymbols}{
    ...
    \begin{abbrv}
        \symbolentry{C}{$\Cinfty(M)$}{Smooth functions on $M$.}
    \end{abbrv}
    \begin{abbrv}
        \symbolentry{C}{$\dev$}{The developing map.}
    \end{abbrv}
    \begin{abbrv}
        \symbolentry{C}{$\hol$}{The affine holonomy representation.}
    \end{abbrv}
    \begin{abbrv}
        \symbolentry{C}{$\aff(\R^n)$}{The group of affine transformations of $\R^n$.}
    \end{abbrv}
    \begin{abbrv}
        \symbolentry{C}{$\affz(\R^n)$}{The group of integral affine transformations of $\R^n$.}
    \end{abbrv}
    \begin{abbrv}
        \symbolentry{C}{$\nabla$}{A connection on the tangent bundle of a manifold.}
    \end{abbrv}
    \begin{abbrv}
        \symbolentry{C}{$\pi_1(M)$}{The fundamental group of $M$.}
    \end{abbrv}
}
