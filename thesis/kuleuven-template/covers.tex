...
\begin{textblock}{160}(-6,63)
    ...
    \vspace{-\parskip}
    \flushleft
    \fontsize{45}{45}\selectfont \textcolor{bluetitle}{The classification of regular Lagrangian fibrations}\\[5.5mm]
    \fontsize{20}{22}\selectfont \parbox{20cm}{over compact surfaces}\\
