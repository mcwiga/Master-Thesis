...
\begin{eg}
    ...
    $M = \mathbb{R}^2- \{0\} / \langle\lambda\rangle$ is an affine manifold. The map
    $$\rho : \mathbb{R}^2 \to \mathbb{R}^2- \{0\}$$
    $$(x,y) \mapsto e^x (\cos y, \sin y)$$
    is a covering map. Basing our fundamental group at $[(1,0)] \in M$, our group is generated by the loops $\gamma_1$ and $\gamma_2$ where $\gamma_1$ is the projection of the line segment joining the point
    $(1,0) \mapsto (\lambda, 0)$ and $\gamma_2$ is the loop going around the unit circle once. These lift to curves $\bar{\gamma}_1$ and $\bar{\gamma}_2$ in the universal cover satisfying
    $$\bar{\gamma}_1(0) = (0,ln(1)) = (0,0), \quad \bar{\gamma}_1(1) = (0,ln(\lambda)) ,$$
    $$\bar{\gamma}_2(0) = (0, 0) , \quad \bar{\gamma}_2(1) = (0, 2\pi),$$
    from this we see that $\gamma_1$ and $\gamma_2$ act on $(x,y)$ by
    $$\gamma_1 \cdot (x,y) = (ln(\gamma) + x, y)$$
